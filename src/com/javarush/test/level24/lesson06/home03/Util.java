...
//                //  String str=(!getTM().equals(Company.Levis.name())&&!getTM().equals(Company.Denim.name()))?  getClass().getSuperclass().getSimpleName():getTM();
//                //   return str+"{" +   не проходит
//                //   return getTM()+"{" +   не проходит
...
//            public Levis(int id, int lengt, int size, double price) {
//                super(id, lengt, size, price);
//            }
//
//            @Override
//            public int getID() {
...
//            public Denim(int id, int lengt, int size, double price) {
//                super(id, lengt, size, price);
//            }
//
//            @Override
